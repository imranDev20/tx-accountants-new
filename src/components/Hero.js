...
const Hero = ({ showModal, setShowModal }) => {
  ...
  return (
    <section className="w-full">
      <div className="fixed top-[92px] lg:top-22 w-full h-[calc(100vh-93px)] -z-50 overflow-hidden before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:bottom-0 before:w-full before:h-full before:bg-primary/75">
        <video
